...
class TestCompilerBootstrap(unittest2.TestCase):
    ...
    def test_assert_equals(self):
        self.assertEquals(0, compile_and_run("assert(equals(1, 1));"))
        self.assertEquals(0, compile_and_run("assert(equals(1, 1));\nassert(equals(2, 2));"))
        self.assertNotEquals(0, compile_and_run("assert(equals(1, 2));\nassert(equals(2, 2));"))
        self.assertNotEquals(0, compile_and_run("assert(equals(1, 1));\nassert(equals(1, 2));"))
        self.assertNotEquals(0, compile_and_run("assert(equals(1, 2));"))
